...
#include "../classification/engine.h"
#include "label_utils.h"
#include "model_utils.h"
#include "../test_utils.h"

ABSL_FLAG(std::string, model_path,
          "/home/andre-criis/Source/coral/classify/models/MobileNetV2/mobilenet_v2_1.0_224_quant_edgetpu.tflite",
          "Path to the tflite model.");

ABSL_FLAG(std::string, image_path, "/home/andre-criis/Source/coral/classify/data/images/parrot.jpg",
          "Path to the image to be classified.");

ABSL_FLAG(std::string, labels_path, "/home/andre-criis/Source/coral/classify/data/images/imagenet_labels.txt",
